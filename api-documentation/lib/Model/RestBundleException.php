...
class RestBundleException implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'code' => 'int',
        'description' => 'string',
        'errors' => '\OpenAPI\Client\Model\RestBundleException[]',
        'field' => 'string'
    ];
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\RestBundleException[]|null
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\RestBundleException[]|null $errors errors
     *
     * @return self
     */
