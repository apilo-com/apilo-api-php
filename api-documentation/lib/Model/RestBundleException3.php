...
class RestBundleException3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'code' => 'int',
        'description' => 'string',
        'errors' => '\OpenAPI\Client\Model\RestBundleException3[]',
        'field' => 'string'
    ];
    ...
    */
     ...
     * Gets errors
     *
     * @return \OpenAPI\Client\Model\RestBundleException3[]|null
     */
     ...
     * Sets errors
     *
     * @param \OpenAPI\Client\Model\RestBundleException3[]|null $errors errors
     *
     * @return self
     */
