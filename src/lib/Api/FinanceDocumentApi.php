...
class FinanceDocumentApi
{
    ...
    public function getRestFinanceDocumentConfigsIndexWithHttpInfo($type = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRestFinanceDocumentConfigsIndex'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Apilo\Model\GetRestFinanceDocumentConfigsIndex200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\GetRestFinanceDocumentConfigsIndex200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\GetRestFinanceDocumentConfigsIndex200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @param  int[] $document_config ID of &lt;a href&#x3D;&#39;#tag/Finance-document/operation/get_rest_finance_document_configs_index&#39;&gt;accounting document numbering series&lt;/a&gt; (optional)
     * @param  int $offset offset (optional)
     * @param  int $limit limit (optional)
    ...
    public function getRestFinanceDocumentIndexWithHttpInfo($type = null, $has_document_document_type = null, $has_not_document_document_type = null, $is_fiscal = null, $document_config = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRestFinanceDocumentIndex'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Apilo\Model\GetRestFinanceDocumentIndex200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\GetRestFinanceDocumentIndex200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\GetRestFinanceDocumentIndex200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function postRestFinanceDocumentsDocumentsCreateWithHttpInfo($id, $rest_document_document_dto, string $contentType = self::contentTypes['postRestFinanceDocumentsDocumentsCreate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 201:
                    if ('\Apilo\Model\RestDocumentDocumentDTO2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\RestDocumentDocumentDTO2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\RestDocumentDocumentDTO2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
