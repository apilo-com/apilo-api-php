...
class AuthorizationApi
{
    ...
    /**
     * Operation postRestAuthTokenpost
     *
     * Obtaining access_token and refresh_token tokens.
     *
     * @param  \Apilo\Model\AuthorizationRequest $authorization_request Obtaining access_token and refresh_token tokens (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postRestAuthTokenpost'] to see the possible values for this operation
     *
     * @throws \Apilo\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Apilo\Model\AuthorizationResponse|\Apilo\Model\RestBundleException|\Apilo\Model\RestBundleException|\Apilo\Model\RestBundleException
     */
    public function postRestAuthTokenpost($authorization_request, string $contentType = self::contentTypes['postRestAuthTokenpost'][0])
    {
        list($response) = $this->postRestAuthTokenpostWithHttpInfo($authorization_request, $contentType);
        return $response;
    }

    /**
     * Operation postRestAuthTokenpostWithHttpInfo
     *
     * Obtaining access_token and refresh_token tokens.
     *
     * @param  \Apilo\Model\AuthorizationRequest $authorization_request Obtaining access_token and refresh_token tokens (required)
     ...
     * @throws \Apilo\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Apilo\Model\AuthorizationResponse|\Apilo\Model\RestBundleException|\Apilo\Model\RestBundleException|\Apilo\Model\RestBundleException, HTTP status code, HTTP response headers (array of strings)
     */
    public function postRestAuthTokenpostWithHttpInfo($authorization_request, string $contentType = self::contentTypes['postRestAuthTokenpost'][0])
    {
        $request = $this->postRestAuthTokenpostRequest($authorization_request, $contentType);
    ...
    /**
     * Operation postRestAuthTokenpostAsync
     *
     * Obtaining access_token and refresh_token tokens.
     *
     * @param  \Apilo\Model\AuthorizationRequest $authorization_request Obtaining access_token and refresh_token tokens (required)
     ...
     */
    public function postRestAuthTokenpostAsync($authorization_request, string $contentType = self::contentTypes['postRestAuthTokenpost'][0])
    {
        return $this->postRestAuthTokenpostAsyncWithHttpInfo($authorization_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postRestAuthTokenpostAsyncWithHttpInfo
     *
     * Obtaining access_token and refresh_token tokens.
     *
     * @param  \Apilo\Model\AuthorizationRequest $authorization_request Obtaining access_token and refresh_token tokens (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postRestAuthTokenpostAsyncWithHttpInfo($authorization_request, string $contentType = self::contentTypes['postRestAuthTokenpost'][0])
    {
        $returnType = '\Apilo\Model\AuthorizationResponse';
        $request = $this->postRestAuthTokenpostRequest($authorization_request, $contentType);
    ...
    /**
     * Create request for operation 'postRestAuthTokenpost'
     *
     * @param  \Apilo\Model\AuthorizationRequest $authorization_request Obtaining access_token and refresh_token tokens (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postRestAuthTokenpost'] to see the possible values for this operation
     *
     ...
     */
    public function postRestAuthTokenpostRequest($authorization_request, string $contentType = self::contentTypes['postRestAuthTokenpost'][0])
    {
        ...
        if ($authorization_request === null || (is_array($authorization_request) && count($authorization_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization_request when calling postRestAuthTokenpost'
            );
        }
