...
class OrderApi
{
     ...
     * @param  mixed $id2 ID of the document (optional)
     * @param  mixed $id_external External unique ID of the document (optional)
     * @param  int $number number (optional)
     * @param  int $type type (optional)
     * @param  mixed $created_after start date of document creation in Apilo, takes the value of ISO 8601 date encoded to URL, e.g. &lt;code&gt;2022-03-01T14:40:33%2B0200&lt;/code&gt; (optional)
     * @param  mixed $created_before end date of document creation in Apilo, takes the value of ISO 8601 date encoded to URL, e.g. &lt;code&gt;2022-03-01T14:40:33%2B0200&lt;/code&gt; (optional)
     * @param  mixed $offset Position indicator (0-beginning, 1-skips one record, 256 - skips 256 records) (optional)
     * @param  mixed $limit Limit of returned results, max 512 records (optional)
    ...
    public function getRestOrderDocumentsIndexWithHttpInfo($id, $id2 = null, $id_external = null, $number = null, $type = null, $created_after = null, $created_before = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRestOrderDocumentsIndex'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Apilo\Model\GetRestOrderDocumentsIndex200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\GetRestOrderDocumentsIndex200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\GetRestOrderDocumentsIndex200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @throws \Apilo\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Apilo\Model\RestOrderReadDTO|\Apilo\Model\RestBundleException|\Apilo\Model\RestBundleException
     */
     ...
     * @throws \Apilo\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Apilo\Model\RestOrderReadDTO|\Apilo\Model\RestBundleException|\Apilo\Model\RestBundleException, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRestOrdersDetailWithHttpInfo($id, string $contentType = self::contentTypes['getRestOrdersDetail'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Apilo\Model\RestOrderReadDTO' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\RestOrderReadDTO' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\RestOrderReadDTO', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Apilo\Model\RestOrderReadDTO';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @param  \DateTime $ordered_after ordered_after (optional)
     * @param  \DateTime $ordered_before ordered_before (optional)
     * @param  \DateTime $updated_after updated_after (optional)
     * @param  \DateTime $updated_before updated_before (optional)
     * @param  int $is_order_document is_order_document (optional)
     * @param  string $id id (optional)
     * @param  string $id_external id_external (optional)
     * @param  int $order_status order_status (optional)
     * @param  int[] $order_status_ids order_status_ids (optional)
     * @param  int $sort Sort options (optional)
     ...
     */
    public function getRestOrdersIndex($created_after = null, $created_before = null, $ordered_after = null, $ordered_before = null, $updated_after = null, $updated_before = null, $is_order_document = null, $id = null, $id_external = null, $order_status = null, $order_status_ids = null, $sort = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRestOrdersIndex'][0])
    {
        list($response) = $this->getRestOrdersIndexWithHttpInfo($created_after, $created_before, $ordered_after, $ordered_before, $updated_after, $updated_before, $is_order_document, $id, $id_external, $order_status, $order_status_ids, $sort, $offset, $limit, $contentType);
        return $response;
    }
     ...
     * @param  \DateTime $ordered_after (optional)
     * @param  \DateTime $ordered_before (optional)
     * @param  \DateTime $updated_after (optional)
     * @param  \DateTime $updated_before (optional)
     * @param  int $is_order_document (optional)
     * @param  string $id (optional)
     * @param  string $id_external (optional)
     * @param  int $order_status (optional)
     * @param  int[] $order_status_ids (optional)
     * @param  int $sort Sort options (optional)
    ...
    {
        $request = $this->getRestOrdersIndexRequest($created_after, $created_before, $ordered_after, $ordered_before, $updated_after, $updated_before, $is_order_document, $id, $id_external, $order_status, $order_status_ids, $sort, $offset, $limit, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Apilo\Model\GetRestOrdersIndex200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\GetRestOrdersIndex200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\GetRestOrdersIndex200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRestOrdersIndexAsync($created_after = null, $created_before = null, $ordered_after = null, $ordered_before = null, $updated_after = null, $updated_before = null, $is_order_document = null, $id = null, $id_external = null, $order_status = null, $order_status_ids = null, $sort = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRestOrdersIndex'][0])
    {
        return $this->getRestOrdersIndexAsyncWithHttpInfo($created_after, $created_before, $ordered_after, $ordered_before, $updated_after, $updated_before, $is_order_document, $id, $id_external, $order_status, $order_status_ids, $sort, $offset, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRestOrdersIndexAsyncWithHttpInfo($created_after = null, $created_before = null, $ordered_after = null, $ordered_before = null, $updated_after = null, $updated_before = null, $is_order_document = null, $id = null, $id_external = null, $order_status = null, $order_status_ids = null, $sort = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRestOrdersIndex'][0])
    {
        $returnType = '\Apilo\Model\GetRestOrdersIndex200Response';
        $request = $this->getRestOrdersIndexRequest($created_after, $created_before, $ordered_after, $ordered_before, $updated_after, $updated_before, $is_order_document, $id, $id_external, $order_status, $order_status_ids, $sort, $offset, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRestOrdersIndexRequest($created_after = null, $created_before = null, $ordered_after = null, $ordered_before = null, $updated_after = null, $updated_before = null, $is_order_document = null, $id = null, $id_external = null, $order_status = null, $order_status_ids = null, $sort = null, $offset = null, $limit = null, string $contentType = self::contentTypes['getRestOrdersIndex'][0])
    {
    ...
    public function getRestOrdersOrderTagListWithHttpInfo($order_id, $offset = null, $limit = null, string $contentType = self::contentTypes['getRestOrdersOrderTagList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Apilo\Model\RestTagsDTO' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\RestTagsDTO' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\RestTagsDTO', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function getRestOrdersShipmentDetailWithHttpInfo($id, $shipment, string $contentType = self::contentTypes['getRestOrdersShipmentDetail'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Apilo\Model\RestOrderShipmentDTO3' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\RestOrderShipmentDTO3' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\RestOrderShipmentDTO3', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function getRestOrdersShipmentListWithHttpInfo($id, $offset = null, $limit = null, string $contentType = self::contentTypes['getRestOrdersShipmentList'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Apilo\Model\GetRestOrdersShipmentList200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\GetRestOrdersShipmentList200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\GetRestOrdersShipmentList200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * Create a new order.
     *
     * @param  \Apilo\Model\RestOrderWriteDTO $rest_order_write_dto  (optional)
    ...
    public function postRestOrdersCreateWithHttpInfo($rest_order_write_dto = null, string $contentType = self::contentTypes['postRestOrdersCreate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Apilo\Model\PostRestOrdersCreate200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\PostRestOrdersCreate200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\PostRestOrdersCreate200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 201:
     ...
     *
     * @param  string $id order number in Apilo system, e.g. &lt;code&gt;AL0012345&lt;/code&gt; (required)
     * @param  \Apilo\Model\RestOrderNoteDTO2 $rest_order_note_dto2 rest_order_note_dto2 (optional)
     ...
     *
     * @param  string $id order number in Apilo system, e.g. &lt;code&gt;AL0012345&lt;/code&gt; (required)
     * @param  \Apilo\Model\RestOrderNoteDTO2 $rest_order_note_dto2 (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postRestOrdersOrderNoteCreate'] to see the possible values for this operation
     *
     * @throws \Apilo\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function postRestOrdersPaymentCreateWithHttpInfo($id, $rest_order_payment_dto, string $contentType = self::contentTypes['postRestOrdersPaymentCreate'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 201:
                    if ('\Apilo\Model\PostRestOrdersPaymentCreate201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\PostRestOrdersPaymentCreate201Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\PostRestOrdersPaymentCreate201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
    ...
    public function putRestOrdersStatusChangeWithHttpInfo($id, $rest_status_order_dto, string $contentType = self::contentTypes['putRestOrdersStatusChange'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Apilo\Model\PutRestOrdersStatusChange200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Apilo\Model\PutRestOrdersStatusChange200Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Apilo\Model\PutRestOrdersStatusChange200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 304:
