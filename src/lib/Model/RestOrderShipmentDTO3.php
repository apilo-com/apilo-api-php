...
class RestOrderShipmentDTO3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestOrderShipmentDTO3., must be bigger than or equal to 1.');
        }
    ...
    public function setIdExternal($id_external)
    {
        ...
        if (!is_null($id_external) && (mb_strlen($id_external) < 0)) {
            throw new \InvalidArgumentException('invalid length for $id_external when calling RestOrderShipmentDTO3., must be bigger than or equal to 0.');
        }
