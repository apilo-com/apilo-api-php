...
/**
 * NewShipmentCreatedDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class NewShipmentCreatedDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewShipmentCreatedDTO';
    ...
    */
    ...
    public function setShipmentId($shipment_id)
    {
        ...
        if (($shipment_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $shipment_id when calling NewShipmentCreatedDTO., must be bigger than or equal to 1.');
        }
