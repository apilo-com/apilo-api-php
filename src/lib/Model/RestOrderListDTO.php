...
/**
 * RestOrderListDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestOrderListDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderListDTO';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 11)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RestOrderListDTO., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RestOrderListDTO., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[A-Za-z0-9\\.|]{10,11}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling RestOrderListDTO., must conform to the pattern /^[A-Za-z0-9\\.|]{10,11}$/.");
        }
    ...
    public function setStatus($status)
    {
        ...
        if (($status < 1)) {
            throw new \InvalidArgumentException('invalid value for $status when calling RestOrderListDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setIdExternal($id_external)
    {
        ...
        if (!is_null($id_external) && (mb_strlen($id_external) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id_external when calling RestOrderListDTO., must be smaller than or equal to 36.');
        }
     ...
     * Sets payment_status
     *
     * @param string|null $payment_status Payment status (`0-no payment`, `1-partially paid`, `2-paid in full/amount in accordance with the order`, `3-overpayment`)
     *
     * @return self
     */
    ...
    public function setPaymentType($payment_type)
    {
        ...
        if (($payment_type < 1)) {
            throw new \InvalidArgumentException('invalid value for $payment_type when calling RestOrderListDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setOriginalCurrency($original_currency)
    {
        ...
        if ((mb_strlen($original_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $original_currency when calling RestOrderListDTO., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($original_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $original_currency when calling RestOrderListDTO., must be bigger than or equal to 3.');
        }
    ...
    public function setPlatformId($platform_id)
    {
        ...
        if (($platform_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $platform_id when calling RestOrderListDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierId($carrier_id)
    {
        ...
        if (($carrier_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $carrier_id when calling RestOrderListDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setPlatformAccountId($platform_account_id)
    {
        ...
        if (($platform_account_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $platform_account_id when calling RestOrderListDTO., must be bigger than or equal to 1.');
        }
