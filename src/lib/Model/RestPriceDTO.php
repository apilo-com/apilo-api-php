...
/**
 * RestPriceDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestPriceDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestPriceDTO';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id > 4294967295)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestPriceDTO., must be smaller than or equal to 4294967295.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestPriceDTO., must be bigger than or equal to 1.');
        }
