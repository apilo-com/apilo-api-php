...
/**
 * RestProductAttributeDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestProductAttributeDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestProductAttributeDTO';
    ...
    protected static $openAPITypes = [
        ...
        'product_id' => 'int',
        'type' => 'int',
        'values' => '\Apilo\Model\ProductAttributeValuesInner[]'
    ];
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestProductAttributeDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setProductId($product_id)
    {
        ...
        if (($product_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $product_id when calling RestProductAttributeDTO., must be bigger than or equal to 1.');
        }
     ...
     * Gets values
     *
     * @return \Apilo\Model\ProductAttributeValuesInner[]|null
     */
     ...
     * Sets values
     *
     * @param \Apilo\Model\ProductAttributeValuesInner[]|null $values Product Attribute Values
     *
     * @return self
     */
