...
class NewShipmentDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'address_receiver' => '\Apilo\Model\NewShipmentDTOAddressReceiver',
        'order_id' => 'string',
        'post_date' => '\DateTime',
        'method' => 'string',
    ...
    */
     ...
     *
     * @return \Apilo\Model\NewShipmentDTOAddressReceiver|null
     */
     ...
     *
     * @param \Apilo\Model\NewShipmentDTOAddressReceiver|null $address_receiver address_receiver
     *
     * @return self
     */
    public function setAddressReceiver($address_receiver)
    {
        if (is_null($address_receiver)) {
            array_push($this->openAPINullablesSetToNull, 'address_receiver');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('address_receiver', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets options
     *
     * @param \Apilo\Model\NewShipmentDTOOptionsInner[]|null $options Options can be downloaded from <a href='#tag/Shipment/operation/get_rest_shipment_options'>Get list of shipment option need to create new shipment</a>.
     *
     * @return self
     */
