 ...
 */
class RestTagDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestTagDTO';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['alias']) && (mb_strlen($this->container['alias']) > 32)) {
            $invalidProperties[] = "invalid value for 'alias', the character length must be smaller than or equal to 32.";
        }
        ...
        if (!is_null($this->container['color']) && (mb_strlen($this->container['color']) > 32)) {
            $invalidProperties[] = "invalid value for 'color', the character length must be smaller than or equal to 32.";
        }
     ...
     * Sets id
     *
     * @param int|null $id Internal Tag ID
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (!is_null($id) && ($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestTagDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setAlias($alias)
    {
        ...
        if (!is_null($alias) && (mb_strlen($alias) > 32)) {
            throw new \InvalidArgumentException('invalid length for $alias when calling RestTagDTO., must be smaller than or equal to 32.');
        }
        if (!is_null($alias) && (mb_strlen($alias) < 1)) {
            throw new \InvalidArgumentException('invalid length for $alias when calling RestTagDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RestTagDTO., must be smaller than or equal to 64.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RestTagDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setColor($color)
    {
        ...
        if (!is_null($color) && (mb_strlen($color) > 32)) {
            throw new \InvalidArgumentException('invalid length for $color when calling RestTagDTO., must be smaller than or equal to 32.');
        }
        if (!is_null($color) && (mb_strlen($color) < 1)) {
            throw new \InvalidArgumentException('invalid length for $color when calling RestTagDTO., must be bigger than or equal to 1.');
        }
