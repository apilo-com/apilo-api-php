...
/**
 * RestProductAttributeTextAreaDTO2 Class Doc Comment
 *
 * @category Class
 * @description This object represents product Attribute text area DTO .
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestProductAttributeTextAreaDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestProductAttributeTextAreaDTO2';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestProductAttributeTextAreaDTO2., must be bigger than or equal to 1.');
        }
