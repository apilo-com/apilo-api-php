...
/**
 * RestOrderPaymentDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestOrderPaymentDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderPaymentDTO';
    ...
    */
    ...
    public function setType($type)
    {
        ...
        if (($type < 1)) {
            throw new \InvalidArgumentException('invalid value for $type when calling RestOrderPaymentDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 128)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling RestOrderPaymentDTO., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($comment) < 0)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling RestOrderPaymentDTO., must be bigger than or equal to 0.');
        }
