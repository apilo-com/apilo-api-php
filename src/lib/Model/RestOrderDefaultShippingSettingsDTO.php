<?php
/**
 * RestOrderDefaultShippingSettingsDTO
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RestOrderDefaultShippingSettingsDTO Class Doc Comment
 *
 * @category Class
 * @description This object represents default shipping settings like mapped delivery and other to an order with the specified ID.
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestOrderDefaultShippingSettingsDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderDefaultShippingSettingsDTO';
    ...
    protected static $openAPITypes = [
        'mapped_delivery' => '\Apilo\Model\RestOrderMappedDeliveryDTO'
    ];
    ...
    protected static $attributeMap = [
        'mapped_delivery' => 'mappedDelivery'
    ];
    ...
    protected static $setters = [
        'mapped_delivery' => 'setMappedDelivery'
    ];
    ...
    protected static $getters = [
        'mapped_delivery' => 'getMappedDelivery'
    ];
    ...
    {
        $this->setIfExists('mapped_delivery', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets mapped_delivery
     *
     * @return \Apilo\Model\RestOrderMappedDeliveryDTO|null
     */
    public function getMappedDelivery()
    {
        return $this->container['mapped_delivery'];
    }

    /**
     * Sets mapped_delivery
     *
     * @param \Apilo\Model\RestOrderMappedDeliveryDTO|null $mapped_delivery mapped_delivery
     *
     * @return self
     */
    public function setMappedDelivery($mapped_delivery)
    {
        if (is_null($mapped_delivery)) {
            throw new \InvalidArgumentException('non-nullable mapped_delivery cannot be null');
        }
        $this->container['mapped_delivery'] = $mapped_delivery;
