...
/**
 * NewShipmentDTOAddressReceiver Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class NewShipmentDTOAddressReceiver implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewShipmentDTO_addressReceiver';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type Address type ('house')
     *
     * @return self
     */
     ...
     * Sets name2
     *
     * @param string|null $name2 Continuation of company name (optional).
     *
     * @return self
     */
     ...
     * Sets tax_number
     *
     * @param string|null $tax_number Tax Identification Number (NIP in Poland).
     *
     * @return self
     */
