...
class RestOrderItemsDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setEan($ean)
    {
        ...
        if ((mb_strlen($ean) > 14)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling RestOrderItemsDTO2., must be smaller than or equal to 14.');
        }
        if ((mb_strlen($ean) < 0)) {
        ...
        if ((!preg_match("/^[0-9]{1,14}$/", ObjectSerializer::toString($ean)))) {
            throw new \InvalidArgumentException("invalid value for \$ean when calling RestOrderItemsDTO2., must conform to the pattern /^[0-9]{1,14}$/.");
        }
     ...
     * Sets product_id
     *
     * @param int|null $product_id Internal <a href='#tag/Warehouse/operation/get_rest_warehouse_product_index'>Product ID</a> in Apilo (according to product card)
     *
     * @return self
     */
    public function setProductId($product_id)
    {
        ...
        if (!is_null($product_id) && ($product_id > 4294967295)) {
