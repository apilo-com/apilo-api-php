...
/**
 * RestProductAttributeTextAreaDTO3 Class Doc Comment
 *
 * @category Class
 ...
 */
class RestProductAttributeTextAreaDTO3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestProductAttributeTextAreaDTO3';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestProductAttributeTextAreaDTO3., must be bigger than or equal to 1.');
        }
