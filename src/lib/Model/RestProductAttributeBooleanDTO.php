...
/**
 * RestProductAttributeBooleanDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class RestProductAttributeBooleanDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestProductAttributeBooleanDTO';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestProductAttributeBooleanDTO., must be bigger than or equal to 1.');
        }
