...
/**
 * RestProductAttributeTextDTO3 Class Doc Comment
 *
 * @category Class
 ...
 */
class RestProductAttributeTextDTO3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestProductAttributeTextDTO3';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestProductAttributeTextDTO3., must be bigger than or equal to 1.');
        }
