...
/**
 * RestProductAttributeBooleanDTO2 Class Doc Comment
 *
 * @category Class
 * @description This object represents product Attribute text boolean DTO .
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestProductAttributeBooleanDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestProductAttributeBooleanDTO2';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestProductAttributeBooleanDTO2., must be bigger than or equal to 1.');
        }
