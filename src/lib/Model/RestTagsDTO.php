 ...
 */
class RestTagsDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestTagsDTO';
    ...
    */
     ...
     * Gets list
     *
     * @return \Apilo\Model\RestTagDTO[]|null
     */
     ...
     * Sets list
     *
     * @param \Apilo\Model\RestTagDTO[]|null $list Rest Order Tag items list
     *
     * @return self
     */
     ...
     *
     * @param int|null $page_result_count Total count per page
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count Count for all order tags
     *
     * @return self
     */
     ...
     * Sets current_offset
     *
     * @param int|null $current_offset Offset
     *
     * @return self
     */
