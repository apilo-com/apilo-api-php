<?php
/**
 * RestShipmentOptionsAndParcelsDTO
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RestShipmentOptionsAndParcelsDTO Class Doc Comment
 *
 * @category Class
 * @description This object represents options describing shipment and way of dividing into several parcels.
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestShipmentOptionsAndParcelsDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestShipmentOptionsAndParcelsDTO';
    ...
    protected static $openAPITypes = [
        'options' => '\Apilo\Model\RestShipmentOptionsDefinitionDTO',
        'parcels' => '\Apilo\Model\RestShipmentOptionsDefinitionDTO',
        'max_parcels_count' => 'int'
    ];
    ...
    protected static $attributeMap = [
        'options' => 'options',
        'parcels' => 'parcels',
        'max_parcels_count' => 'maxParcelsCount'
    ];
    ...
    protected static $setters = [
        'options' => 'setOptions',
        'parcels' => 'setParcels',
        'max_parcels_count' => 'setMaxParcelsCount'
    ];
    ...
    protected static $getters = [
        'options' => 'getOptions',
        'parcels' => 'getParcels',
        'max_parcels_count' => 'getMaxParcelsCount'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('max_parcels_count', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets options
     *
     * @return \Apilo\Model\RestShipmentOptionsDefinitionDTO|null
     */
     ...
     * Sets options
     *
     * @param \Apilo\Model\RestShipmentOptionsDefinitionDTO|null $options options
     *
     * @return self
     */
     ...
     * Sets parcels
     *
     * @param \Apilo\Model\RestShipmentOptionsDefinitionDTO|null $parcels parcels
     *
     * @return self
     */
    ...
    /**
     * Gets max_parcels_count
     *
     * @return int|null
     */
    public function getMaxParcelsCount()
    {
        return $this->container['max_parcels_count'];
    }

    /**
     * Sets max_parcels_count
     *
     * @param int|null $max_parcels_count Number of parcels into which the shipment can be divided.
     *
     * @return self
     */
    public function setMaxParcelsCount($max_parcels_count)
    {
        if (is_null($max_parcels_count)) {
            throw new \InvalidArgumentException('non-nullable max_parcels_count cannot be null');
        }
        $this->container['max_parcels_count'] = $max_parcels_count;
