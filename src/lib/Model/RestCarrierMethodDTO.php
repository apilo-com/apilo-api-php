...
/**
 * RestCarrierMethodDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestCarrierMethodDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestCarrierMethodDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Internal carrier sending method ID
     *
     * @return self
     */
