...
/**
 * RestProductAttributeTextDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class RestProductAttributeTextDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestProductAttributeTextDTO';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestProductAttributeTextDTO., must be bigger than or equal to 1.');
        }
