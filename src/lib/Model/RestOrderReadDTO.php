    ...
    */
    ...
    public function setPlatformAccountId($platform_account_id)
    {
        ...
        if (($platform_account_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $platform_account_id when calling RestOrderReadDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setPlatformId($platform_id)
    {
        ...
        if (($platform_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $platform_id when calling RestOrderReadDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setPaymentType($payment_type)
    {
        ...
        if (($payment_type < 1)) {
            throw new \InvalidArgumentException('invalid value for $payment_type when calling RestOrderReadDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierAccount($carrier_account)
    {
        ...
        if (($carrier_account < 1)) {
            throw new \InvalidArgumentException('invalid value for $carrier_account when calling RestOrderReadDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9\\.|]{10,11}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling RestOrderReadDTO., must conform to the pattern /^[A-Za-z0-9\\.|]{10,11}$/.");
        }
