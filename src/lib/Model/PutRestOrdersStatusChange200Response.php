...
/**
 * PutRestOrdersStatusChange200Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class PutRestOrdersStatusChange200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'put_rest_orders_status_change_200_response';
    ...
    */
    ...
    public function setUpdates($updates)
    {
        ...
        if (($updates < 0)) {
            throw new \InvalidArgumentException('invalid value for $updates when calling PutRestOrdersStatusChange200Response., must be bigger than or equal to 0.');
        }
