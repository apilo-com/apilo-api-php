...
/**
 * RestOrderMappedDeliveryDTO Class Doc Comment
 *
 * @category Class
 * @description This object represents mapped carrier account ID and carrier method
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestOrderMappedDeliveryDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestOrderMappedDeliveryDTO';
    ...
    protected static $setters = [
        ...
        'carrier_method' => 'setCarrierMethod',
        '_help' => 'setHelp'
    ];
    ...
    protected static $getters = [
        ...
        'carrier_method' => 'getCarrierMethod',
        '_help' => 'getHelp'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('carrier_method', $data ?? [], null);
        $this->setIfExists('_help', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['carrier_account_id']) && ($this->container['carrier_account_id'] > 65535)) {
            $invalidProperties[] = "invalid value for 'carrier_account_id', must be smaller than or equal to 65535.";
        }
    ...
    public function setCarrierAccountId($carrier_account_id)
    {
        ...
        if (!is_null($carrier_account_id) && ($carrier_account_id > 65535)) {
            throw new \InvalidArgumentException('invalid value for $carrier_account_id when calling RestOrderMappedDeliveryDTO., must be smaller than or equal to 65535.');
        }
        if (!is_null($carrier_account_id) && ($carrier_account_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $carrier_account_id when calling RestOrderMappedDeliveryDTO., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['carrier_method'];
    }

    /**
     * Sets carrier_method
     *
     * @param string|null $carrier_method Carrier sending method ID
     *
     * @return self
     */
    public function setCarrierMethod($carrier_method)
    {
        if (is_null($carrier_method)) {
            throw new \InvalidArgumentException('non-nullable carrier_method cannot be null');
        }
        $this->container['carrier_method'] = $carrier_method;
     ...
     * Gets _help
     *
     * @return \Apilo\Model\RestHelpDTO|null
     */
    public function getHelp()
    {
        return $this->container['_help'];
    }

    /**
     * Sets _help
     *
     * @param \Apilo\Model\RestHelpDTO|null $_help _help
     *
     * @return self
     */
    ...
    {
        if (is_null($_help)) {
            throw new \InvalidArgumentException('non-nullable _help cannot be null');
        }
        $this->container['_help'] = $_help;
