...
/**
 * RestAttributesIndexResponse Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestAttributesIndexResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestAttributesIndexResponse';
    ...
    protected static $openAPITypes = [
        'attributes' => '\Apilo\Model\RestAttributeDTO[]',
        'total_count' => 'int',
        'current_offset' => 'int',
    ...
    */
     ...
     * Gets attributes
     *
     * @return \Apilo\Model\RestAttributeDTO[]
     */
     ...
     * Sets attributes
     *
     * @param \Apilo\Model\RestAttributeDTO[] $attributes Attribute items list
     *
     * @return self
     */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling RestAttributesIndexResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrentOffset($current_offset)
    {
        ...
        if (($current_offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_offset when calling RestAttributesIndexResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setPageResultCount($page_result_count)
    {
        ...
        if (($page_result_count > 512)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling RestAttributesIndexResponse., must be smaller than or equal to 512.');
        }
        if (($page_result_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling RestAttributesIndexResponse., must be bigger than or equal to 0.');
        }
