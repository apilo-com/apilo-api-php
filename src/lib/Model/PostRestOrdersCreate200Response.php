...
/**
 * PostRestOrdersCreate200Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class PostRestOrdersCreate200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_rest_orders_create_200_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[A-Za-z0-9\\.|]{10,11}$/", $this->container['id'])) {
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 11)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PostRestOrdersCreate200Response., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($id) < 10)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PostRestOrdersCreate200Response., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/^[A-Za-z0-9\\.|]{10,11}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling PostRestOrdersCreate200Response., must conform to the pattern /^[A-Za-z0-9\\.|]{10,11}$/.");
        }
