...
/**
 * RestAttributeDTO3 Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestAttributeDTO3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestAttributeDTO3';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'name' => 'string',
        'attribute_features' => '\Apilo\Model\AttributeFeaturesInner2[]'
    ];
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestAttributeDTO3., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RestAttributeDTO3., must be smaller than or equal to 64.');
        }
     ...
     *
     * @return \Apilo\Model\AttributeFeaturesInner2[]|null
     */
     ...
     *
     * @param \Apilo\Model\AttributeFeaturesInner2[]|null $attribute_features Attribute Features
     *
     * @return self
     */
