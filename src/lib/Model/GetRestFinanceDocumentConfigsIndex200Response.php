...
/**
 * GetRestFinanceDocumentConfigsIndex200Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class GetRestFinanceDocumentConfigsIndex200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_rest_finance_document_configs_index_200_response';
    ...
    */
     ...
     *
     * @param \Apilo\Model\RestDocumentConfigDTO[]|null $document_configs List of numbering series of accounting documents
     *
     * @return self
     */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling GetRestFinanceDocumentConfigsIndex200Response., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrentOffset($current_offset)
    {
        ...
        if (($current_offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_offset when calling GetRestFinanceDocumentConfigsIndex200Response., must be bigger than or equal to 0.');
        }
    ...
    public function setPageResultCount($page_result_count)
    {
        ...
        if (($page_result_count > 512)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling GetRestFinanceDocumentConfigsIndex200Response., must be smaller than or equal to 512.');
        }
        if (($page_result_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling GetRestFinanceDocumentConfigsIndex200Response., must be bigger than or equal to 0.');
        }
