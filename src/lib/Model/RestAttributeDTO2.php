...
/**
 * RestAttributeDTO2 Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestAttributeDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestAttributeDTO2';
    ...
    protected static $openAPITypes = [
        'type' => 'int',
        'name' => 'string',
        'attribute_features' => '\Apilo\Model\AttributeFeaturesInner1[]'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RestAttributeDTO2., must be smaller than or equal to 64.');
        }
     ...
     *
     * @return \Apilo\Model\AttributeFeaturesInner1[]|null
     */
     ...
     *
     * @param \Apilo\Model\AttributeFeaturesInner1[]|null $attribute_features Attribute Features
     *
     * @return self
     */
