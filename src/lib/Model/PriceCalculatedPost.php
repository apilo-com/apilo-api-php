...
class PriceCalculatedPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'product' => 'int',
        'price' => 'int',
        'custom_price_modify' => '\Apilo\Model\PriceCalculatedPostCustomPriceModify',
        'custom_mode' => 'int'
    ];
    ...
    public const CUSTOM_MODE_NUMBER_3 = 3;
    public const CUSTOM_MODE_NUMBER_5 = 5;
    public const CUSTOM_MODE_NUMBER_6 = 6;
    public const CUSTOM_MODE_NUMBER_7 = 7;
     ...
     * @return string[]
     */
    public function getCustomModeAllowableValues()
    {
        return [
            self::CUSTOM_MODE_NUMBER_3,
            self::CUSTOM_MODE_NUMBER_5,
            self::CUSTOM_MODE_NUMBER_6,
            self::CUSTOM_MODE_NUMBER_7,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCustomModeAllowableValues();
        if (!is_null($this->container['custom_mode']) && !in_array($this->container['custom_mode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'custom_mode', must be one of '%s'",
                $this->container['custom_mode'],
     ...
     *
     * @return \Apilo\Model\PriceCalculatedPostCustomPriceModify
     */
     ...
     *
     * @param \Apilo\Model\PriceCalculatedPostCustomPriceModify $custom_price_modify custom_price_modify
     *
     * @return self
     */
    ...
    public function setCustomMode($custom_mode)
    {
        ...
        $allowedValues = $this->getCustomModeAllowableValues();
        if (!in_array($custom_mode, $allowedValues, true)) {
