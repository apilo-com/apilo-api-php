...
/**
 * PostRestOrdersPaymentCreate201Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class PostRestOrdersPaymentCreate201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_rest_orders_payment_create_201_response';
    ...
    */
    ...
    public function setUpdates($updates)
    {
        ...
        if (($updates < 0)) {
            throw new \InvalidArgumentException('invalid value for $updates when calling PostRestOrdersPaymentCreate201Response., must be bigger than or equal to 0.');
        }
