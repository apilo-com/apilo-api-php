 ...
 *
 * @category Class
 * @description Collection of personal info belongs to Fiscal document
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setCompanyTaxNumber($company_tax_number)
    {
        if (is_null($company_tax_number)) {
            array_push($this->openAPINullablesSetToNull, 'company_tax_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('company_tax_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($company_tax_number) && (mb_strlen($company_tax_number) > 64)) {
    ...
    public function setStreetName($street_name)
    {
        ...
        if (!is_null($street_name) && (mb_strlen($street_name) > 128)) {
    ...
    public function setStreetNumber($street_number)
    {
        ...
        if (!is_null($street_number) && (mb_strlen($street_number) > 32)) {
