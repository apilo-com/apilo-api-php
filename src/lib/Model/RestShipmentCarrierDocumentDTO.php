<?php
/**
 * RestShipmentCarrierDocumentDTO
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RestShipmentCarrierDocumentDTO Class Doc Comment
 *
 * @category Class
 * @description This object represents a single shipment carrier document.
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestShipmentCarrierDocumentDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestShipmentCarrierDocumentDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Internal document ID
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestShipmentCarrierDocumentDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierAccountId($carrier_account_id)
    {
        ...
        if (($carrier_account_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $carrier_account_id when calling RestShipmentCarrierDocumentDTO., must be bigger than or equal to 1.');
        }
     ...
     * Sets type
     *
     * @param int|null $type Document type - <a href='#tag/order/paths/~1rest~1api~1orders~1documents~1map~1/get'>order document types endpoint</a>
     *
     * @return self
     */
