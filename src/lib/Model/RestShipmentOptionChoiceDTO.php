...
/**
 * RestShipmentOptionChoiceDTO Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestShipmentOptionChoiceDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestShipmentOptionChoiceDTO';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'type' => 'string',
        'value' => '\Apilo\Model\RestShipmentOptionChoiceValueDTO[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'choice');
    ...
    */
     ...
     * Gets value
     *
     * @return \Apilo\Model\RestShipmentOptionChoiceValueDTO[]|null
     */
     ...
     * Sets value
     *
     * @param \Apilo\Model\RestShipmentOptionChoiceValueDTO[]|null $value Value
     *
     * @return self
     */
