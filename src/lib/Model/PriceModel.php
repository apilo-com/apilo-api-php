...
class PriceModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'price' => false,
        'product' => false,
        'custom_price_with_tax' => true,
        'custom_price_modify' => true,
        'custom_mode' => true
    ];
    ...
    */
    ...
    public function setCustomPriceWithTax($custom_price_with_tax)
    {
        if (is_null($custom_price_with_tax)) {
            array_push($this->openAPINullablesSetToNull, 'custom_price_with_tax');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('custom_price_with_tax', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setCustomPriceModify($custom_price_modify)
    {
        if (is_null($custom_price_modify)) {
            array_push($this->openAPINullablesSetToNull, 'custom_price_modify');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('custom_price_modify', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setCustomMode($custom_mode)
    {
        if (is_null($custom_mode)) {
            array_push($this->openAPINullablesSetToNull, 'custom_mode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('custom_mode', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
