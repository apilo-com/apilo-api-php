...
/**
 * GetRestWarehouseCategoryIndex200Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class GetRestWarehouseCategoryIndex200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_rest_warehouse_category_index_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'categories' => '\Apilo\Model\RestCategoryDTO[]'
    ];
    ...
    */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling GetRestWarehouseCategoryIndex200Response., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrentOffset($current_offset)
    {
        ...
        if (($current_offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_offset when calling GetRestWarehouseCategoryIndex200Response., must be bigger than or equal to 0.');
        }
    ...
    public function setPageResultCount($page_result_count)
    {
        ...
        if (($page_result_count > 512)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling GetRestWarehouseCategoryIndex200Response., must be smaller than or equal to 512.');
        }
        if (($page_result_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling GetRestWarehouseCategoryIndex200Response., must be bigger than or equal to 0.');
        }
     ...
     * Gets categories
     *
     * @return \Apilo\Model\RestCategoryDTO[]|null
     */
     ...
     * Sets categories
     *
     * @param \Apilo\Model\RestCategoryDTO[]|null $categories categories
     *
     * @return self
     */
