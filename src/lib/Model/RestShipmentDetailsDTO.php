...
/**
 * RestShipmentDetailsDTO Class Doc Comment
 *
 * @category Class
 * @description This object represents a single shipment.
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestShipmentDetailsDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestShipmentDetailsDTO';
    ...
    */
     ...
     * Sets status_date
     *
     * @param \DateTime|null $status_date Status change date
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $status_check_timestamp Status check date
     *
     * @return self
     */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestShipmentDetailsDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierAccountId($carrier_account_id)
    {
        ...
        if (($carrier_account_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $carrier_account_id when calling RestShipmentDetailsDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierBrokerId($carrier_broker_id)
    {
        ...
        if (($carrier_broker_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $carrier_broker_id when calling RestShipmentDetailsDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setExternalId($external_id)
    {
        ...
        if (!is_null($external_id) && (mb_strlen($external_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling RestShipmentDetailsDTO., must be smaller than or equal to 36.');
        }
        if (!is_null($external_id) && (mb_strlen($external_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling RestShipmentDetailsDTO., must be bigger than or equal to 0.');
        }
