<?php
/**
 * RestShippingConfirmationsListingResponseDTO
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RestShippingConfirmationsListingResponseDTO Class Doc Comment
 *
 * @category Class
 * @description This object represents an list of shipping confirmations.
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestShippingConfirmationsListingResponseDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestShippingConfirmationsListingResponseDTO';
    ...
    protected static $openAPITypes = [
        'shipping_confirmations' => '\Apilo\Model\RestShippingConfirmationsListingItemDTO[]'
    ];
    ...
    protected static $attributeMap = [
        'shipping_confirmations' => 'shippingConfirmations'
    ];
    ...
    protected static $setters = [
        'shipping_confirmations' => 'setShippingConfirmations'
    ];
    ...
    protected static $getters = [
        'shipping_confirmations' => 'getShippingConfirmations'
    ];
    ...
    {
        $this->setIfExists('shipping_confirmations', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets shipping_confirmations
     *
     * @return \Apilo\Model\RestShippingConfirmationsListingItemDTO[]|null
     */
    public function getShippingConfirmations()
    {
        return $this->container['shipping_confirmations'];
    }

    /**
     * Sets shipping_confirmations
     *
     * @param \Apilo\Model\RestShippingConfirmationsListingItemDTO[]|null $shipping_confirmations List of shipping confirmations
     *
     * @return self
     */
    public function setShippingConfirmations($shipping_confirmations)
    {
        if (is_null($shipping_confirmations)) {
            throw new \InvalidArgumentException('non-nullable shipping_confirmations cannot be null');
        }
        $this->container['shipping_confirmations'] = $shipping_confirmations;
