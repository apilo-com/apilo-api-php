...
/**
 * RestShippingConfirmationDTO Class Doc Comment
 *
 * @category Class
 ...
 */
class RestShippingConfirmationDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestShippingConfirmationDTO';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['shipment_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'shipment_id', must be bigger than or equal to 1.";
        }
     ...
     * Sets shipment_id
     *
     * @param int $shipment_id Internal shipment ID
     *
     * @return self
     */
    public function setShipmentId($shipment_id)
    {
        ...
        if (($shipment_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $shipment_id when calling RestShippingConfirmationDTO., must be bigger than or equal to 1.');
        }
     ...
     * Sets type
     *
     * @param int $type Carrier document type (1 - TYPE_SEND_FROM_STACK, 2 - TYPE_CMR)
     *
     * @return self
     */
     ...
     * Sets pickup_id
     *
     * @param string|null $pickup_id Pickup ID form <a href='#tag/Shipment/operation/post_rest_shipment_pickup_date_proposal'>Get shipment pick up date proposal</a> or NULL
     *
     * @return self
     */
