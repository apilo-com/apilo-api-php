<?php
/**
 * RestShipmentPickupDateProposalsDTO
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * RestShipmentPickupDateProposalsDTO Class Doc Comment
 *
 * @category Class
 * @description This object represents a single shipment pickup date proposals.
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestShipmentPickupDateProposalsDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestShipmentPickupDateProposalsDTO';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['shipment_id']) && ($this->container['shipment_id'] < 1)) {
     ...
     * Sets shipment_id
     *
     * @param int|null $shipment_id Internal shipment ID
     *
     * @return self
     */
    public function setShipmentId($shipment_id)
    {
        ...
        if (($shipment_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $shipment_id when calling RestShipmentPickupDateProposalsDTO., must be bigger than or equal to 1.');
        }
     ...
     * Sets type
     *
     * @param int|null $type Carrier document type (1 - TYPE_SEND_FROM_STACK, 2 - TYPE_CMR)
     *
     * @return self
     */
     ...
     * Sets pickup_date
     *
     * @param mixed[]|null $pickup_date Pickup date proposals
     *
     * @return self
     */
