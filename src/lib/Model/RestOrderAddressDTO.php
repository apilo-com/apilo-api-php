    ...
    */
    ...
    public function setParcelIdExternal($parcel_id_external)
    {
        ...
        if ((mb_strlen($parcel_id_external) > 64)) {
            throw new \InvalidArgumentException('invalid length for $parcel_id_external when calling RestOrderAddressDTO., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($parcel_id_external) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parcel_id_external when calling RestOrderAddressDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setParcelName($parcel_name)
    {
        ...
        if ((mb_strlen($parcel_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $parcel_name when calling RestOrderAddressDTO., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($parcel_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $parcel_name when calling RestOrderAddressDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setCompanyTaxNumber($company_tax_number)
    {
        ...
        if ((mb_strlen($company_tax_number) > 64)) {
            throw new \InvalidArgumentException('invalid length for $company_tax_number when calling RestOrderAddressDTO., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($company_tax_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $company_tax_number when calling RestOrderAddressDTO., must be bigger than or equal to 0.');
        }
    ...
    public function setCompanyName($company_name)
    {
        ...
        if ((mb_strlen($company_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling RestOrderAddressDTO., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($company_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling RestOrderAddressDTO., must be bigger than or equal to 0.');
        }
