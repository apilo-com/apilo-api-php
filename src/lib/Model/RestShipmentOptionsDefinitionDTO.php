...
/**
 * RestShipmentOptionsDefinitionDTO Class Doc Comment
 *
 * @category Class
 * @description This object represents options describing shipment. You will learn from it what the definitions of individual options look like and which of them are mandatory.
 * @package  Apilo
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestShipmentOptionsDefinitionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestShipmentOptionsDefinitionDTO';
    ...
    protected static $openAPITypes = [
        ...
        'label' => 'string',
        'multiple' => 'bool',
        'properties' => '\Apilo\Model\RestShipmentOptionDTO2[]',
        'required' => 'mixed[]'
    ];
    ...
    public const TYPE_DIMENSIONS = 'dimensions';
    ...
    */
     ...
     * Sets label
     *
     * @param string|null $label A label that describes an option.
     *
     * @return self
     */
     ...
     * Sets multiple
     *
     * @param bool|null $multiple Specifies whether the application expects one or many objects of this type.
     *
     * @return self
     */
     ...
     * Gets properties
     *
     * @return \Apilo\Model\RestShipmentOptionDTO2[]|null
     */
     ...
     * Sets properties
     *
     * @param \Apilo\Model\RestShipmentOptionDTO2[]|null $properties List of options describing the shipment as delivery method, insurance, pickup point, etc.
     *
     * @return self
     */
     ...
     * Sets required
     *
     * @param mixed[]|null $required List of required options.
     *
     * @return self
     */
