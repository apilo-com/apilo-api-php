...
class RestShipmentOptionsDefinitionDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'label' => 'string',
        'multiple' => 'bool',
        'properties' => '\Apilo\Model\RestShipmentOptionDTO[]',
        'required' => 'mixed[]'
    ];
    ...
    */
     ...
     * Sets properties
     *
     * @param \Apilo\Model\RestShipmentOptionDTO[]|null $properties List of options describing the shipment as delivery method, insurance, pickup point, etc.
     *
     * @return self
     */
