...
/**
 * GetRestOrderDocumentsIndex200Response Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class GetRestOrderDocumentsIndex200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_rest_order_documents_index_200_response';
    ...
    protected static $openAPITypes = [
        'documents' => '\Apilo\Model\RestOrderDocumentDTO3[]',
        'total_count' => 'int',
        'current_offset' => 'int',
    ...
    */
     ...
     * Gets documents
     *
     * @return \Apilo\Model\RestOrderDocumentDTO3[]|null
     */
     ...
     * Sets documents
     *
     * @param \Apilo\Model\RestOrderDocumentDTO3[]|null $documents List of order documents
     *
     * @return self
     */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling GetRestOrderDocumentsIndex200Response., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrentOffset($current_offset)
    {
        ...
        if (($current_offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_offset when calling GetRestOrderDocumentsIndex200Response., must be bigger than or equal to 0.');
        }
    ...
    public function setPageResultCount($page_result_count)
    {
        ...
        if (($page_result_count > 512)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling GetRestOrderDocumentsIndex200Response., must be smaller than or equal to 512.');
        }
        if (($page_result_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_result_count when calling GetRestOrderDocumentsIndex200Response., must be bigger than or equal to 0.');
        }
