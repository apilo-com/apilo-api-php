...
/**
 * RestProductAttributeDTO2 Class Doc Comment
 *
 * @category Class
 * @package  Apilo
 * @author   OpenAPI Generator team
 ...
 */
class RestProductAttributeDTO2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RestProductAttributeDTO2';
    ...
    protected static $openAPITypes = [
        ...
        'product_id' => 'int',
        'type' => 'int',
        'values' => '\Apilo\Model\ProductAttributeValuesInner1[]'
    ];
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling RestProductAttributeDTO2., must be bigger than or equal to 1.');
        }
    ...
    public function setProductId($product_id)
    {
        ...
        if (($product_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $product_id when calling RestProductAttributeDTO2., must be bigger than or equal to 1.');
        }
     ...
     * Gets values
     *
     * @return \Apilo\Model\ProductAttributeValuesInner1[]|null
     */
     ...
     * Sets values
     *
     * @param \Apilo\Model\ProductAttributeValuesInner1[]|null $values Product Attribute Values
     *
     * @return self
     */
