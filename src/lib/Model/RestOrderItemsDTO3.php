...
class RestOrderItemsDTO3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setEan($ean)
    {
        ...
        if ((mb_strlen($ean) > 14)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling RestOrderItemsDTO3., must be smaller than or equal to 14.');
        }
        if ((mb_strlen($ean) < 0)) {
        ...
        if ((!preg_match("/^[0-9]{1,14}$/", ObjectSerializer::toString($ean)))) {
            throw new \InvalidArgumentException("invalid value for \$ean when calling RestOrderItemsDTO3., must conform to the pattern /^[0-9]{1,14}$/.");
        }
